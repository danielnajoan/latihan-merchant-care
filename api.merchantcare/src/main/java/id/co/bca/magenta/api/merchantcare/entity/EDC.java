...
public class EDC {
	...
	private String fasilitasmerchant;
	private String fasilitasedc;
	private String fasilitasedc_tid;
	...
	public String getFasilitasmerchant() {
		return fasilitasmerchant;
	}
	public void setFasilitasmerchant(String fasilitasmerchant) {
		this.fasilitasmerchant = fasilitasmerchant;
	}
	public String getFasilitasedc() {
		return fasilitasedc;
	}
	public void setFasilitasedc(String fasilitasedc) {
		this.fasilitasedc = fasilitasedc;
	}
	public String getFasilitasedc_tid() {
		return fasilitasedc_tid;
	}
	public void setFasilitasedc_tid(String fasilitasedc_tid) {
		this.fasilitasedc_tid = fasilitasedc_tid;
	}
	...
	public String toString() {
		...
		builder.append(brand);
		builder.append(", fasilitasmerchant=");
		builder.append(fasilitasmerchant);
		builder.append(", fasilitasedc=");
		builder.append(fasilitasedc);
		builder.append(", fasilitasedc_tid=");
		builder.append(fasilitasedc_tid);
		...
		builder.append(KartuKreditAccNo);
		builder.append(", stockist_id=");
		builder.append(stockist_id);
		builder.append(", stockist=");
		builder.append(stockist);
