...
public class Criteria {
	...
	public static final String DELIMITER1 = StaticVariable.getProp("mms.properties.delimiter1");
	public static final String DELIMITER2 = StaticVariable.getProp("mms.properties.delimiter3");
	public static final String DELIMITER3 = StaticVariable.getProp("mms.properties.delimiter3");
	public static final String[] DELIMITER_OPT = new String[]{AND_OPT,OR_OPT};
	...
	public String toString() {
		...
		if (operator.equals(EQUALS) && left.toUpperCase().contains("MID")) {
			...
			criteria.append(APOSTROPHE);
		} else if (!right.toUpperCase().contains("NULL") && (operator.equals(EQUALS) || operator.equals(NOTEQUAL) || operator.equals(LESS)
		...
		if (operator.equals(IN) && !right.toUpperCase().contains("NULL")) {
			criteria.append(ENCLOSE);
			if (left.equals("MID") || left.equals("mid")) {
				criteria.append(APOSTROPHE);
				criteria.append(right);
				criteria.append(APOSTROPHE);
			} else {
